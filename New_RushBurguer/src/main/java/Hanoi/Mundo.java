...
public class Mundo extends JPanel implements ActionListener, MouseListener {
    ...
    public Mundo() throws IOException {
        ...
        //Label que muestra el numero de pasos que a echo el jugador
    ...
    //Método que Agrega el numero determinado de Aros
     ...
     //@param n, número de aros que se van a agregar a la torre
    ...
    //Meotodo para verificar si el aro que se va a poner es mas pequeño que el que hay en la torre
     //@param aroPresente
     //@param aroAMover
     //@return
